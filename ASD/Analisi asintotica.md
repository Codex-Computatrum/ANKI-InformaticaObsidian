...
#### Dimostrazione sulla notazione $\Theta$
...
##### Caso 1 h(n) dall'alto della dimostrazione sulla notazione $\Theta$
...
##### Caso 2 h(n) dal basso della dimostrazione sulla notazione $\Theta$
...
#### Caso oscillatorio della dimostrazione sulla notazione $Theta$
...
### Quali notazioni asintotiche godono della proprietà transitiva?
